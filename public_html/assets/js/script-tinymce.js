$(document).ready(function() {
	tinymce.init({
		...
		image_advtab: true,
		imagetools_cors_hosts: [location.hostname, 'www.tinymce.com', 'codepen.io'],
		imagetools_toolbar: "editimage imageoptions",
		image_title: true,
		automatic_uploads: true,
		file_picker_types: 'image', 
		images_upload_url: location.origin+'/editor/site/uploadfile',
		menubar: false,
		content_css: [
		location.origin+'/assets/css/bootstrap.min.css',
		location.origin+'/assets/css/mytinymce.css'
		],
